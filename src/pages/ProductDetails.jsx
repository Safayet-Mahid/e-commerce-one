...
const ProductDetails = () => {
  ...
  const {imgUrl,productName,price,reviews,avgRating,category,description,shortDesc} = product
          ...
          <Row>
            <Col lg="12">
              <div className="tab__wrapper d-flex align-items-center gap-5">
                ...
                <h6 className={`${tab==="review"? "active__tab":""}`} onClick={()=>setTab("review")}>Reviews ({reviews.length})</h6>
              </div>
